...
namespace vrt { // store in official namespace
    ...
    typedef enum VtStructureType : uint32_t {
        ...
        VT_STRUCTURE_TYPE_DEVICE_AGGREGATION_INFO = 0x11F0000F,
        ...
        VT_STRUCTURE_TYPE_ACCELERATOR_BUILD_INFO = 0x11F00015,
    } VtStructureType;
    ...
    typedef enum VtEntryUsageFlags : uint32_t {
        VT_ENTRY_USAGE_CLOSEST_BIT = 0x00000001,
        VT_ENTRY_USAGE_MISS_BIT = 0x00000002,
        VT_ENTRY_USAGE_GENERATION_BIT = 0x00000004,
        VT_ENTRY_USAGE_GROUP_BIT = 0x00000008,
    } VtEntryUsageFlags;
