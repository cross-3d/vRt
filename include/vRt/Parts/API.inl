...
namespace vt { // store in official namespace
    ...
    extern inline VtResult vtCmdBuildVertexAssembly(VtCommandBuffer commandBuffer, bool useInstance = true, std::function<void(VkCommandBuffer, int, VtUniformBlock&)> cb = {});
