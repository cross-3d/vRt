...
namespace _vt {
    ...
    constexpr const static inline auto INTENSIVITY = 2048ull;
    ...
    constexpr const static inline auto RV_INTENSIVITY = 1024ull;
    constexpr const static inline auto VX_INTENSIVITY = 1024ull;
