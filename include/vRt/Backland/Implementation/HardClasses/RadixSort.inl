...
namespace _vt {
    ...
    VtResult createRadixSort(std::shared_ptr<Device> _vtDevice, VtDeviceAggregationInfo vtExtension, std::shared_ptr<RadixSort>& vtRadix) {
        constexpr const auto STEPS = VRT_USE_MORTON_32 ? 4ull : 8ull, WG_COUNT = 64ull, RADICE_AFFINE = 256ull; // 8-bit (NOT effective in RX Vega)
