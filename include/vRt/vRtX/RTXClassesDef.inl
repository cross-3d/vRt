...
namespace _vt {
    ...
    static inline void cmdRaytracingBarrierNVX(VkCommandBuffer cmdBuffer) {
        ...
        vkCmdPipelineBarrier(
            cmdBuffer,
            VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT | VK_PIPELINE_STAGE_TRANSFER_BIT | VK_PIPELINE_STAGE_RAYTRACING_BIT_NVX | VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT,
            VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT | VK_PIPELINE_STAGE_TRANSFER_BIT | VK_PIPELINE_STAGE_RAYTRACING_BIT_NVX | VK_PIPELINE_STAGE_VERTEX_INPUT_BIT,
            {},
            1, &memoryBarrier,
            0, nullptr,
            0, nullptr);
