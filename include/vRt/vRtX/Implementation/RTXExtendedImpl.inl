...
namespace vrt {
    ...
    VtResult VtRTXAcceleratorExtension::_Criteria(const std::shared_ptr<_vt::DeviceFeatures>& lwFeatures) const {
    ...
    VtResult VtRTXAcceleratorExtension::_Initialization(const std::shared_ptr<_vt::Device>& lwDevice, std::shared_ptr<_vt::AcceleratorExtensionBase>& _hExtensionAccelerator) const {
    ...
    VtResult VtRTXAcceleratorExtension::_DeviceInitialization(const std::shared_ptr<_vt::Device>& vtDevice) const {
